# Patches for a Raspberry Pi 3 based Whonix Gateway #

This package provides the firmware files, fstab and network config to build a physically isolated Whonix gateway for the Raspberry Pi 3.
